...
class _MainScreenState extends State<BMainPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            PageView(
              children: [
                Image.asset('images/main/main1.jpg'),
                Image.asset('images/main/main2.jpg'),
                Image.asset('images/main/main3.jpg'),
              ],
            ),
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(
                            10.0), // 캐러셀모서리를 둥글게, 이미지를 넣으면 직각으로 변함 따라서
                      ),
                  ...
                  builder: (BuildContext context) {
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        color: Colors.grey,
                        borderRadius: BorderRadius.circular(
                            10.0), //'캐러셀 슬라이더'를 둥글게 처리, 근데 이미지 넣으면 상단 부분이 직각이 되어버림.
                      ),
                      child: ImageGraphCarousel(
                        imagePath: 'images/login/logo.png',
                        // 그래프 위젯
