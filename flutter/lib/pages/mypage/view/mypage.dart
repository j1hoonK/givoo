...
class MyPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<String> list =["기부영수증 전송", "전자기부금영수증 신청(홈텍스신고)","문의사항","공지사항","약관/정책"];
    List<String> pushList=["/mypage/announce","/mypage/announce","/mypage/qna","/mypage/announce","/mypage/terms"];
                              ...
                              children: [
                                ...
                                Container(margin: EdgeInsets.only(left: 8),
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        child: Text( provider.kakaoUser[0].userName,
                                          style: TextStyle(
                                            color: Colors.white,
                                            fontSize: 20,
                                            letterSpacing: 2.0,
                                      ...
                                      Container(
                                        width: width*0.6,
                                        child: Text("님은 세상을 따뜻하게 만드는 기부에 참여하고 계십니다",
                                          softWrap: true,
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      decoration: BoxDecoration(
                                        color: Colors.grey, // Container의 배경색
                                        borderRadius: BorderRadius.vertical(bottom: Radius.circular(12)), // 테두리 모양과 크기 설정
                                      ),
                                      alignment: Alignment.center,
                                      height: height*0.06,
                                      width: width,
                                      child: Text("Wow!! 이렇게 많은 기부를 하고 계시네요.",style: TextStyle(
                                        fontSize:15,
                                        color: Colors.white,
                                      ),
                                      ),
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [InkWell(
                                      ...
                                      child: Column(
                                        children: [Icon(CupertinoIcons.list_bullet,color: Colors.orangeAccent,),
                                          Text("기부내역")
                                        ],
                                      ),
                                    ),VerticalDivider(thickness: 1, width: 1, color: Colors.white),
                                      Column(
                                      children: [Icon(CupertinoIcons.calendar,color: Colors.orangeAccent,),
                                        Text("기부금 공제")
                                      ],
                                    ),VerticalDivider(thickness: 1, width: 1, color:  Colors.white),
                                      InkWell(
                                        ...
                                        child: Column(
                                        children: [Icon(CupertinoIcons.bookmark_fill,color: Colors.orangeAccent,),
                                          Text("내 기부단체")
                                        ],
                                    ),
                                      ),],
