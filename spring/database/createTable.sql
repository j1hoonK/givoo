...
(
    ...
    `org_number`     int NOT NULL COMMENT '기부포털 등록번호' ,
    ...
    `org_notice`     varchar(450) NULL COMMENT '기관 공지사항(1차)' ,
    `org_owner`      varchar(45) NOT NULL COMMENT '대표자' ,
    `started_up`     date NOT NULL COMMENT '설립일' ,
    `account_number` bigint NULL COMMENT '계좌번호' ,
...
(
    `notice_id` int NOT NULL AUTO_INCREMENT ,
    `notice_body` varchar(450) NOT NULL COMMENT '본문' ,
